...
func (c *networkServiceClient) GetNetworkStats(ctx context.Context, in *GetNetworkStatsRequest, opts ...grpc.CallOption) (*GetNetworkStatsResponse, error) {
...
func (UnimplementedNetworkServiceServer) GetNetworkStats(context.Context, *GetNetworkStatsRequest) (*GetNetworkStatsResponse, error) {
...
func _NetworkService_GetNetworkStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NetworkServiceServer).GetNetworkStats(ctx, req.(*GetNetworkStatsRequest))
	}
