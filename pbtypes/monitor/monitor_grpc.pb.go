...
type MonitorServiceClient interface {
	...
	StreamStats(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[StatsRequest, StatsResponse], error)
...
func (c *monitorServiceClient) StreamStats(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[StatsRequest, StatsResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type MonitorService_StreamStatsClient = grpc.BidiStreamingClient[StatsRequest, StatsResponse]
...
type MonitorServiceServer interface {
	...
	// Stream từ Agent gửi về Server (requires authentication)
	StreamStats(grpc.BidiStreamingServer[StatsRequest, StatsResponse]) error
	// Get stats for a specific hostname
...
func (UnimplementedMonitorServiceServer) StreamStats(grpc.BidiStreamingServer[StatsRequest, StatsResponse]) error {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type MonitorService_StreamStatsServer = grpc.BidiStreamingServer[StatsRequest, StatsResponse]
