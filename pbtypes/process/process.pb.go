...
type GetProcessesRequest struct {
	...
	SortBy        string                 `protobuf:"bytes,2,opt,name=sort_by,json=sortBy,proto3" json:"sort_by,omitempty"` // e.g., "cpu", "memory", "name", "pid"
	Order         string                 `protobuf:"bytes,3,opt,name=order,proto3" json:"order,omitempty"`                 // e.g., "asc", "desc"
...
func (x *GetProcessesRequest) GetSortBy() string {
	if x != nil {
		return x.SortBy
	}
	return ""
...
func (x *GetProcessesRequest) GetOrder() string {
	if x != nil {
		return x.Order
	}
	return ""
...
const file_process_process_proto_rawDesc = "" +
	...
	"\x04port\x18\x06 \x01(\x05R\x04port\"B\n" +
